<header>
    <div id="MenuInicio"
        class="opacity-0-animation animation animation-slow animation-forwards animation-delay-1s menuInicio fixed-top z-3">
    </div>
    <nav class="navbar fixed-top z-3 opacity-0-animation animation animation-slow animation-forwards animation-delay-1s">
        ...
        <div class="container-fluid">
            ...
            <div class="popover__wrapper">
                <div>
                    ...
                    @guest
                        <a href="{{ route('login') }}" class="popover__title d-none d-sm-block"><img
                                class="imagenPerfilNav" src="{{ asset('Imagenes/guest.png') }}" alt=""> Inicia
                            sesion</a>
