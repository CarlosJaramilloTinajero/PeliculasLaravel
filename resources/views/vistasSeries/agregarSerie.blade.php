...
<div class="container p-5" style="margin-top: 100px;">
   ...
   <br>
   <form method="POST" action="{{route('agregarSerie')}}" enctype="multipart/form-data">
      @csrf
      <div class="mb-3">
      ...
      <div class="mb-3">
         <label for="Name" class="form-label">Categoria de la serie
         </label>
      ...
      <div class="mb-3">
         <label for="imagen" class="form-label">Imagen de la serie
