...
<div class="container p-5 " style="margin-top: 100px;">
    ...
    <br>
    <form method="POST" action="{{route('update.serie',['serie' => $serie->id])}}" enctype="multipart/form-data">
        @csrf
        @method('PATCH')
        <div class="mb-3">
        ...
        <div class="mb-3">
            <label for="Name" class="form-label">Descripcion de la serie
            ...
            <textarea class="form-control" name="descripcion" id="" cols="30" rows="10">{{$serie->descripcion}}</textarea>
        </div>

        <div class="mb-3">
            <label for="Name" class="form-label">Categoria de la serie</label>
        ...
        <div class="mb-3">
            ...
            <br>
            <small>Imagen actual:</small><br><a target="_black" href="{{asset($serie->imagen)}}"><img src="{{asset($serie->imagen)}}" alt="Imagen actual" style="width: 50px; height: 70px;"></a><br></br>
            <label for="imagen" class="form-label">Modificar Imagen de la serie
